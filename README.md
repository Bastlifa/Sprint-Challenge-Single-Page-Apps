...
> Answer: Client-side routing doesn't need to refresh the page, so it doesn't have to keep asking the server for files. It asks for everything up-front. It can be faster because of this, but also slower to load initially
- [ ] What does AJAX stand for?
> Answer: Asynchronous JavaScript and XML.
- [ ] What are `controlled components` in React?
> Answer: Controlled components are components which are affected by state.
